...
class webfft {
  ...
  fft2d(inputArray) {
    ...
    for (let i = 0; i < outterLen; i++) {
      intermediateArray.push(this.fft(inputArray[i]));
    }

    console.log(intermediateArray[0][0]);
