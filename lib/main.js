...
//import NayukiWasmFftWrapperWasm from "./nayukic/webfftWrapper.js";  // kept getting error Uncaught TypeError: Cannot create property 'read' on number '1024' when running the benchmark within the site
...
class webfft {
  ...
  setSubLibrary(subLibrary) {
    switch (subLibrary) {
      case "nayukiJavascript":
        ...
        break;
      // kept getting error Uncaught TypeError: Cannot create property 'read' on number '1024' when running the benchmark within the site
      //case "nayuki3Wasm":
  ...
  availableSubLibraries() {
    return [
      ...
      "nockertJavascript",
      "nayukiJavascript",
      //"nayuki3Wasm", // kept getting error Uncaught TypeError: Cannot create property 'read' on number '1024' when running the benchmark within the site
      "kissWasm",
      "crossWasm",
      "dntjJavascript",
      "mljsJavascript"
