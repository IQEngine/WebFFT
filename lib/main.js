...
class webfft {
  ...
  fft2d(inputArray) {
    ...
    console.log(inputArray[0].slice(0, 2));
    console.log(inputArray[1].slice(0, 2));
    console.log(inputArray[2].slice(0, 2));
    console.log(inputArray[3].slice(0, 2));
    console.log("---");
    ...
    console.log(intermediateArray[0].slice(0, 2));
    console.log(intermediateArray[1].slice(0, 2));
    console.log(intermediateArray[2].slice(0, 2));
    console.log(intermediateArray[3].slice(0, 2));
    /*
    Float32Array(2) [ -0.03318902850151062, -0.17398615181446075 ]
    Float32Array(2) [ -0.03318902850151062, -0.17398615181446075 ]
    Float32Array(2) [ -0.03318902850151062, -0.17398615181446075 ]
    Float32Array(2) [ -0.03318902850151062, -0.17398615181446075 ]
    */
    ...
    for (let i = 0; i < innerLen; i++) {
      ...
      if (i === 0) {
        ...
        // 0.17266629+0.02986823j, 0.1722076 +0.03054477j
        // 0.02986823-0.14039072j, 0.03004992-0.13993408j
        // -0.14039072-0.18157424j, -0.13973678-0.18175853j
        // -0.18157424-0.05581948j, -0.18104944-0.0564748j
      }
  ...
  availableSubLibraries() {
    return [
      ...
      //"kissfftmodifiedWasm", // currnetly doesnt perform any better
      //"viljaWasm"
    ];
  }

  profile(duration = 1, refresh = true) {
